...
tolerance = 0.0001
names = ["gnesterovnode", "nadamnode"]
alt_names = ["GNesterovNODE Euler 0.2", "NadamNODE Euler 0.2"]
df_names = {}
for name in names:
    filepath = f"../output/cifar/{name}/{name}_euler_0.2_{tolerance}_.csv"
...
plt.legend(bbox_to_anchor=(0.5, axbox.y0), loc="lower center",
