...
class MODEL(nn.Module):
    def __init__(self):
        ...
        self.ode_rnn = ODE_RNN_with_Grad_Listener(self.cell, self.rnn, nhid, self.ic, rnn_out=True, tol=1e-7, time_requires_grad=False, evaluation_times=evaluation_times)
